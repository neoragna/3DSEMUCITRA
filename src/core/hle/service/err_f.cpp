...
static std::string GetErrType(u8 type_code) {
    ...
    case FatalErrType::Corrupted:      return "Corrupted";
    case FatalErrType::CardRemoved:    return "CardRemoved";
...
static void LogGenericInfo(const ErrInfo::ErrInfoCommon& errinfo_common)
{
    ...
    LOG_CRITICAL(Service_ERR, "AID: 0x%08X_0x%08X", errinfo_common.app_title_id_high, errinfo_common.app_title_id_low);
