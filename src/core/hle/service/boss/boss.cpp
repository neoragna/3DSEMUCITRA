...
void RegisterPrivateRootCa(Service::Interface* self) {
    ...
    LOG_WARNING(Service_BOSS, "(STUBBED) translation=0x%08X, buff_addr=0x%08X, buff_size=0x%08X", translation, buff_addr, buff_size);
}
...
void RegisterPrivateClientCert(Service::Interface* self) {
    ...
    LOG_WARNING(Service_BOSS, "(STUBBED) unk_param1=0x%08X, unk_param2=0x%08X, translation1=0x%08X, buff1_addr=0x%08X, buff1_size=0x%08X, translation2=0x%08X, buff2_addr=0x%08X, buff2_size=0x%08X",
                unk_param1, unk_param2, translation1, buff1_addr, buff1_size, translation2, buff2_addr, buff2_size);
}
...
void RegisterTask(Service::Interface* self) {
    ...
    LOG_WARNING(Service_BOSS, "(STUBBED) unk_param1=0x%08X, unk_param2=0x%08X, unk_param3=0x%08X, translation=0x%08X, buff_addr=0x%08X, buff_size=0x%08X",
...
void UnregisterTask(Service::Interface* self) {
    ...
    LOG_WARNING(Service_BOSS, "(STUBBED) unk_param1=0x%08X, unk_param2=0x%08X, translation=0x%08X, buff_addr=0x%08X, buff_size=0x%08X",
...
void GetNsDataIdList(Service::Interface* self) {
    ...
    LOG_WARNING(Service_BOSS, "(STUBBED) unk_param1=0x%08X, unk_param2=0x%08X, unk_param3=0x%08X, unk_param4=0x%08X, translation=0x%08X, buff_addr=0x%08X, buff_size=0x%08X",
...
void SendPropertyHandle(Service::Interface* self) {
    ...
    LOG_WARNING(Service_BOSS, "(STUBBED) unk_param1=0x%08X, translation=0x%08X, buff_addr=0x%08X, buff_size=0x%08X",
...
void ReceiveProperty(Service::Interface* self) {
    ...
    LOG_WARNING(Service_BOSS, "(STUBBED) unk_param1=0x%08X, buff_size=0x%08X, translation=0x%08X, buff_addr=0x%08X",
...
void UpdateTaskCount(Service::Interface* self) {
    ...
    LOG_WARNING(Service_BOSS, "(STUBBED) buff_size=0x%08X, unk_param2=0x%08X, translation=0x%08X, buff_addr=0x%08X",
...
void GetTaskState(Service::Interface* self) {
    ...
    u32 buff_size = cmd_buff[1];
    u32 unk_param2 = cmd_buff[2] & 0xFF; // TODO(JamePeng): Figure out the meaning of these parameters
    u32 translation = cmd_buff[3];
    u32 buff_addr = cmd_buff[4];
...
void SetNsDataNewFlag(Service::Interface* self) {
    ...
    LOG_WARNING(Service_BOSS, "(STUBBED) unk_param1=0x%08X, ns_data_new_flag=0x%08X", unk_param1, ns_data_new_flag);
}
...
void RegisterStorageEntry(Service::Interface* self) {
    ...
    LOG_WARNING(Service_BOSS, "(STUBBED)  unk_param1=0x%08X, unk_param2=0x%08X, unk_param3=0x%08X, unk_param4=0x%08X, unk_param5=0x%08X",
