...
static const ResultCode ERROR_INVALID_OPEN_FLAGS(ErrorDescription::FS_InvalidOpenFlags,
                                                 ErrorModule::FS, ErrorSummary::Canceled,
                                                 ErrorLevel::Status);
static const ResultCode ERROR_NOT_FOUND(ErrorDescription::FS_NotFound, ErrorModule::FS,
                                        ErrorSummary::NotFound, ErrorLevel::Status);
static const ResultCode ERROR_UNEXPECTED_FILE_OR_DIRECTORY_SDMC(ErrorDescription::FS_NotAFile,
                                                                ErrorModule::FS,
                                                                ErrorSummary::Canceled,
                                                                ErrorLevel::Status);
static const ResultCode ERROR_ALREADY_EXISTS(ErrorDescription::FS_AlreadyExists, ErrorModule::FS,
