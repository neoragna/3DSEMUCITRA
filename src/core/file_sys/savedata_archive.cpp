...
static const ResultCode ERROR_INVALID_PATH(ErrorDescription::FS_InvalidPath, ErrorModule::FS,
...
static const ResultCode ERROR_UNSUPPORTED_OPEN_FLAGS(ErrorDescription::FS_UnsupportedOpenFlags,
                                                     ...
                                                     ErrorLevel::Usage);
static const ResultCode ERROR_FILE_NOT_FOUND(ErrorDescription::FS_FileNotFound, ErrorModule::FS,
                                             ErrorSummary::NotFound, ErrorLevel::Status);
static const ResultCode ERROR_PATH_NOT_FOUND(ErrorDescription::FS_PathNotFound, ErrorModule::FS,
                                             ErrorSummary::NotFound, ErrorLevel::Status);
static const ResultCode ERROR_UNEXPECTED_FILE_OR_DIRECTORY(
    ErrorDescription::FS_UnexpectedFileOrDirectory, ErrorModule::FS, ErrorSummary::NotSupported,
    ErrorLevel::Usage);
static const ResultCode ERROR_DIRECTORY_ALREADY_EXISTS(ErrorDescription::FS_DirectoryAlreadyExists,
                                                       ErrorModule::FS,
                                                       ErrorSummary::NothingHappened,
                                                       ErrorLevel::Status);
static const ResultCode ERROR_FILE_ALREADY_EXISTS(ErrorDescription::FS_FileAlreadyExists,
                                                  ErrorModule::FS, ErrorSummary::NothingHappened,
                                                  ErrorLevel::Status);
static const ResultCode ERROR_DIRECTORY_NOT_EMPTY(ErrorDescription::FS_DirectoryNotEmpty,
...
ResultVal<std::unique_ptr<FileBackend>> SaveDataArchive::OpenFile(const Path& path,
    ...
    auto full_path = path_parser.BuildHostPath(mount_point);

    switch (path_parser.GetHostStatus(mount_point)) {
    case PathParser::InvalidMountPoint:
        LOG_CRITICAL(Service_FS, "Invalid mount point %s", mount_point.c_str());
    ...
    if (!file.IsOpen()) {
        LOG_CRITICAL(Service_FS, "Unknown error opening %s", full_path.c_str());
        return ERROR_FILE_NOT_FOUND;
    }
...
ResultCode SaveDataArchive::DeleteFile(const Path& path) const {
    ...
    LOG_CRITICAL(Service_FS, "Unknown error deleting %s", full_path.c_str());
    return ERROR_FILE_NOT_FOUND;
}
...
ResultCode SaveDataArchive::CreateDirectory(const Path& path) const {
    ...
    if (FileUtil::CreateDir(mount_point + path.AsString()))
        return RESULT_SUCCESS;
    LOG_CRITICAL(Service_FS, "Unknown error creating %s", mount_point.c_str());
